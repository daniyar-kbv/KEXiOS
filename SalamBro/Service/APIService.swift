...
//    }
    ...
    func getCartProducts() -> [CartProduct] {
        ...
        for i in 0..<6 {
            temp.append(CartProduct(id: i, name: "Item \(i)", description: [nil, "Ingridient template"].randomElement()!, price: [300, 1500].randomElement()!, count: Int.random(in: 1...4), commentary: ["big comment to fit 1 line and blah blab bkah", nil].randomElement()!, available: Bool.random()))
        }
        temp.append(CartProduct(id: 3, name: "Item \(3) 23456721e9uh29ee893289012e20909i0a9s0u98u08j08j", description:  "049u54803utr034it-9i45t20u45tu-45ut-45ut-935-95-95u4t-935-935u-u45t-rut-9u43t-9ur-9-io5-to0t-04t-0iu45t-9u45t9-3tu9u-u", price: [300, 1500].randomElement()!, count: Int.random(in: 1...4), commentary: [nil].randomElement()!, available: true))
        return temp
    }
    ...
    func getCart() -> Cart {
        ...
        let cart = Cart(id: 0, totalProducts: products.count + additional.count, totalPrice: totalPrice, products: products, productsAdditional: additional)
        return cart
    }
}
