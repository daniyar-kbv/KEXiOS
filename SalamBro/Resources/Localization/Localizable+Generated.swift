...
internal enum L10n {
    ...
    internal enum SelectMainInfo {
        ...
        internal enum Alert {
            /// Вы уверены?
            internal static let title = L10n.tr("Localizable", "select_main_info.alert.title")
            internal enum Action {
                /// Нет
                internal static let no = L10n.tr("Localizable", "select_main_info.alert.action.no")
                /// Да
                internal static let yes = L10n.tr("Localizable", "select_main_info.alert.action.yes")
            }

            internal enum Body {
                /// Если Вы сейчас смените адрес, то потеряете все выбранные Вами продукты. Вы действительно хотите сменить адрес?
                internal static let address = L10n.tr("Localizable", "select_main_info.alert.body.address")
                /// Если Вы сейчас смените бренд, то потеряете все выбранные Вами продукты. Вы действительно хотите сменить бренд?
                internal static let brand = L10n.tr("Localizable", "select_main_info.alert.body.brand")
            }
        }
    }
}
